...
static inline void neon_kernel_6x8(const int P, const double *__restrict A,
                                   const int lda,
                                   ...
                                   double *__restrict C, const int ldc)
{
    ...
    float64x2_t c40 = vld1q_f64(C + 4 * ldc);       float64x2_t c41 = vld1q_f64(C + 4 * ldc + 2);
    float64x2_t c42 = vld1q_f64(C + 4 * ldc + 4);   float64x2_t c43 = vld1q_f64(C + 4 * ldc + 6);

    float64x2_t c50 = vld1q_f64(C + 5 * ldc);       float64x2_t c51 = vld1q_f64(C + 5 * ldc + 2);
    float64x2_t c52 = vld1q_f64(C + 5 * ldc + 4);   float64x2_t c53 = vld1q_f64(C + 5 * ldc + 6);
    ...
    for (int l = 0; l < P; l++) {
        ...
        c52 = vfmaq_f64(c52, a5, b2); c53 = vfmaq_f64(c53, a5, b3);
    }
    ...
    vst1q_f64(C + 4 * ldc, c40);        vst1q_f64(C + 4 * ldc + 2, c41);
    vst1q_f64(C + 4 * ldc + 4, c42);    vst1q_f64(C + 4 * ldc + 6, c43);

    vst1q_f64(C + 5 * ldc, c50);        vst1q_f64(C + 5 * ldc + 2, c51);
    vst1q_f64(C + 5 * ldc + 4, c52);    vst1q_f64(C + 5 * ldc + 6, c53);
}
